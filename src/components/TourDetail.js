  ...
  return (
    <View style={styles.wrapper} {...props}>
      ...
      <View style={styles.body}>
        <Tags>
          <Tag evaluator={tour.acf.number_of_days}>
            {tourPlan.acf.number_of_days} days
          </Tag>
        ...
        <Html
          ...
          evaluation={tour.acf['short_description:']}
          source={{html: tour.acf['short_description:']}}></Html>

        <Html
          textStyle={styles.descriptionText}
          evaluation={tourPlan.acf.additional_description}
          source={{html: tourPlan.acf.additional_description}}></Html>
